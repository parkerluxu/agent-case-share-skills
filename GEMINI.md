...
Use `plugins/agent-case-share-skills/skills/search-agent-case-share` when the user asks to search, discover, or read Agent Case Share categories, tags, cases, articles, AI news, public projects, papers, repositories, reusable assets, or Markdown article content.
